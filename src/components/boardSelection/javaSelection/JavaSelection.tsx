...
const JavaSelection = () => {
    ...
    async function fetchVideoData() {
        try {
            // Step 1: Search for videos matching the java
    ...
    return (
        <div className="w-full flex flex-col border border-black p-5 gap-5">
            <div className="flex flex-col gap-2">
                <p className="font-bold text-2xl font-serif">Expand your career opportunities with Java</p>
                <p className="resize-none line-clamp-3">
                    Take one of LCode range of Java courses and learn how to code using this incredibly useful language.
                    Its simple syntax and readability make Java perfect for Flask, Django, data science, and machine learning.
                ...
                <button className="border border-slate-600 p-2 rounded-md font-bold w-fit">Explore Java</button>
            </div>
